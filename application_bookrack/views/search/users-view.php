			            ...
			            <div class="well well-sm">
			                <div class="media">
			                    ...
			                    <div class="media-body">
			                		...
			                		<p><span class="label label-info"><?=$this->common_functions->convert_distance($user["distance"])?> miles</span> <a class="btnBorrow" href="<?=$site_url?>/borrow/request" title="send borrow request" bookid="<?=$bookId?>" Booktitle="<?=$bookTitle?>" to="<?=$user["id"]?>"><span class="label label-warning">Borrow request</span></a></p>
			                        <p>
