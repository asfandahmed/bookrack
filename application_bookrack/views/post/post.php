...
<div class="col-sm-12 col-md-12 col-lg-12 custom-panel post posts" id="post_<?=$post->statusId?>">
		...
		<div class="row postBook">
			...
			<div class="col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-sm-4 col-md-4 col-lg-4"><img src="<?=base_url().'assets/images/book-256.png'?>" height="120px" width="120px" alt="" title=""></div>
